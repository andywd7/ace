...
import { storiesOf } from '../Button/node_modules/@storybook/vue'
import { boolean, radios, select, text } from '../Button/node_modules/@storybook/addon-knobs'
import icons from '../../_storybook/utils/font-icons-helper'

import Badge from './Badge'

const stories = storiesOf('Components|Bootstrap|Badge', module)
